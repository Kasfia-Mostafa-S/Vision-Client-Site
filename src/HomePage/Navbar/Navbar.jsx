      ...
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-end">
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-2 mr-5 z-[1] pl-5 shadow bg-base-100 rounded-box w-52"
            >
              {user ? (
                <li>
                  <a onClick={handleSignOut} className="text-white">
                    Log Out
                  </a>
                </li>
              ) : (
                <Link to="/login">
                  <li>
                    <a className="text-white bg-sky-400">Login</a>
                  </li>
                </Link>
              )}
            </ul>
