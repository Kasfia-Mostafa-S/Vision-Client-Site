...
const Services = () => {
  return (
    <div className="py-10">
      <h2 className="py-3 my-4 text-center bg-gradient-to-tr from-blue-400 to-sky-600 text-4xl font-bold">
        Our Services
      </h2>
                ...
                <div className="solution_cards_box">
                  <div className="solution_card">
                    ...
                    <div className="solu_description">
                      <p>
                        Many consumers are interested in eco-friendly options
                        and may inquire about the energy efficiency of the
                        devices sold on the website.
                      </p>
              ...
              <div className="our_solution_category">
                <div className="solution_cards_box">
                  <div className="solution_card">
                    ...
                    <div className="solu_description">
                      <p>
                        Warranty information is crucial for consumers to ensure
                        their purchases are protected against defects or
                        malfunctions.
                      </p>
                      <button className="read_more_btn" type="button">
                        Read More
              ...
              <div className="our_solution_category">
                <div className="solution_cards_box">
                  <div className="solution_card">
                    ...
                    <div className="solu_description">
                      <p>
                      Users might want to know the range of electric devices available on the website, such as appliances, gadgets, tools, or even electric vehicles.
                      </p>
                      <button className="read_more_btn" type="button">
                        Read More
                      </button>
